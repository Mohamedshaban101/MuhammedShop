        ...
        <div className='section-bags py-2 sm:py-5 bg-white'>
            <div className="container">
                <div className='flex justify-between items-centetr mb-6'>
                    <h2 className='text-[14px] sm:text-[22px] text-black font-bold'>Bags Products</h2>
                ...
                <div className='relative bags-product-slider my-5 '>
                    ...
                    <>
                        <div className="swiper-btn-next flex justify-center items-center w-[30px] sm:w-[50px] h-[30px] sm:h-[50px] absolute top-1/2 left-12 z-10 -translate-y-1/2">
                            <RiArrowLeftSLine className="text-black cursor-pointer text-[30px] sm:text-[50px] custom-bags-prev" />
                        </div>
                        <div className="swiper-btn-prev flex justify-center items-center w-[30px] sm:w-[50px] h-[30px] sm:h-[50px] absolute top-1/2 right-12 z-10 -translate-y-1/2">
                            <RiArrowRightSLine className="text-black cursor-pointer text-[30px] sm:text-[50px] custom-bags-next" />
                        </div>
                    </>
                    : ''
                    }
                    <Swiper
                        ...
                        navigation={
                            showNavigation  ?
                                {
                                    nextEl: '.custom-bags-next',
                                    prevEl: '.custom-bags-prev'
                                } : false
                        }
                        breakpoints={{
                            1400: {
                        ...
                        onSlideChange={(swiper) => {
                            const nextBtn = document.querySelector('.custom-bags-next');
                            const prevBtn = document.querySelector('.custom-bags-prev');
