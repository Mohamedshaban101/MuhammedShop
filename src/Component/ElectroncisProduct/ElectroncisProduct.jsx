    ...
    return (
        <div className='section-electroncis py-2 sm:py-5 bg-white'>
            <div className="container">
                ...
                <div className='relative electroncis-product-slider my-5 '>
                    {
                        showNavigation ?
                            <>
                                <div className="swiper-btn-next flex justify-center items-center w-[30px] sm:w-[50px] h-[30px] sm:h-[50px] absolute top-1/2 left-12 z-10 -translate-y-1/2">
                                    <RiArrowLeftSLine className="text-black text-[30px] sm:text-[50px] cursor-pointer custom-electroncis-prev transition" />
                                </div>
                                <div className="swiper-btn-prev flex justify-center items-center w-[30px] sm:w-[50px] h-[30px] sm:h-[50px] absolute top-1/2 right-12 z-10 -translate-y-1/2">
                                    <RiArrowRightSLine className="text-black text-[30px] sm:text-[50px] cursor-pointer custom-electroncis-next transition" />
                                </div>
                            </>
                            : ''
                    }
                    <Swiper
                        ...
                        navigation={
                            showNavigation ?
                                {
                                    nextEl: '.custom-electroncis-next',
                                    prevEl: '.custom-electroncis-prev'
                                } : false
                        }
                        breakpoints={{
                            1400: {
                        ...
                        onSlideChange={(swiper) => {
                            const nextBtn = document.querySelector('.custom-electroncis-next');
                            const prevBtn = document.querySelector('.custom-electroncis-prev');
...
export default ElectroncisProduct