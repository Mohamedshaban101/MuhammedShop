...
const FootwearProduct = () => {
    ...
    return (
        <div className='section-footwear py-2 sm:py-5 bg-white'>
            <div className="container">
                <div className='flex justify-between items-centetr mb-6'>
                    <h2 className='text-[14px] sm:text-[22px] text-black font-bold'>Footwear Products</h2>
                ...
                <div className='relative footwear-product-slider my-5 '>
                    {
                        showNavigation ?
                            <>
                                <div className="swiper-btn-next flex justify-center items-center w-[30px] sm:w-[50px] h-[30px] sm:h-[50px] absolute top-1/2 left-12 z-10 -translate-y-1/2">
                                    <RiArrowLeftSLine className="text-black text-[30px] sm:text-[50px] cursor-pointer custom-footwear-prev transition" />
                                </div>
                                <div className="swiper-btn-prev flex justify-center items-center w-[30px] sm:w-[50px] h-[30px] sm:h-[50px] absolute top-1/2 right-12 z-10 -translate-y-1/2">
                                    <RiArrowRightSLine className="text-black text-[30px] sm:text-[50px] cursor-pointer custom-footwear-next transition" />
                                </div>
                            </>
                            : ''
                    }
                    <Swiper
                        ...
                        navigation={
                            showNavigation ?
                                {
                                    nextEl: '.custom-footwear-next',
                                    prevEl: '.custom-footwear-prev'
                                } : false
                        }
                        breakpoints={{
                            1400: {
                        ...
                        onSlideChange={(swiper) => {
                            const nextBtn = document.querySelector('.custom-footwear-next');
                            const prevBtn = document.querySelector('.custom-footwear-prev');
